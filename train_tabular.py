...
parser.add_argument('--batchsize', help='Minibatch size',
...
parser.add_argument('--val-batchsize', help='minibatch size',
                    type=int, default=1000)
...
if args.data == 'miniboone':
    train_dset, _, test_dset = tabular.get_tabular_datasets(
        args.data, args.dataroot)
    data_dim = 43
